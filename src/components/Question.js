...
function Question (props) {
  ...
  return (
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        ...
        subheader={timeConverter(props.question.timestamp)}
        ...
        <CardContent>
          ...
          <Button variant="contained" component={RouterLink} to={`/questions/${props.questionid}`} color='primary' style={{ marginTop: '10px', marginBottom: '10px', float: 'right' }}>View poll</Button>
        </CardContent>
