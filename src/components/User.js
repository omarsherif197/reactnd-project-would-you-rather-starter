...
function User (props) {
  const img = props.user.avatarURL
  return (
        ...
        <CardContent>
          ...
          <Typography variant= "body1" component="div" style={{ textAlign: 'center', padding: '5px' }}>{props.user.questions.length}</Typography>
           </Box>
          <Typography variant= "body1" component="div" style={{ textAlign: 'center', fontWeight: 'bold', padding: '5px' }}>Answered questions: </Typography>
          <Box border={0} borderRadius={16} style= {{ background: '#e8eaed' }}>
          <Typography variant= "body1" component="div" style={{ textAlign: 'center', padding: '5px' }}>{Object.keys(props.user.answers).length}</Typography>
          </Box>
        </CardContent>
